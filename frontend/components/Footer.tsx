  ...
  return (
    ...
    <div className="flex flex-col w-full mt-10">
      ...
      <div className="flex justify-center  bg-gray-100 py-6">
        {["Canada", "United States", "Saudi Arabia", "United Kingdom", "Brazil", "Singapore"].map((country, index) => (
          <Link
            key={country}
            href="#"
      ...
      <div className="w-9/12 mx-auto py-12 px-4 grid grid-cols-4 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-500">17 Princess Road, London, Greater London</p>
      ...
      <div className=" bg-gray-800 text-gray-400 py-6 px-4 text-sm">
        <p className="ml-46">All Rights Reserved ©Copyright 2018 by XpeedStudio.</p>
      </div>
